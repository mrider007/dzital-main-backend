...
const adminRepository = {
    ...
    getRejectedUsers: async (req) => {
        try {
            ...
            let rejectedusers = User.aggregate([
                {
                    $lookup: {
                        from: 'membership_plans',
                        localField: 'plan_id',
            ...
            let allRejectedUsers = await User.aggregatePaginate(rejectedusers, options);
            return allRejectedUsers;
        } catch (e) {
            throw e;
        }
    },
