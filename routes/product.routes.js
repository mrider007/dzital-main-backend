...
router.post('/user/product/list', request_param.any(), Authentication.Authenticate, ProductController.userOwnProducts);
...
router.get('/common/product/detail/:id', ProductController.commonProductDetail);
